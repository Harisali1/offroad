    ...
    (t = function() {
        ...
        return function(a, n) {
            ...
            if (i.defaults = {
                    ...
                    eventListToggler: !0,
                    calendarEvents: null
                }, i.options = e.extend({}, i.defaults, n), i.initials = {
                    ...
                    dates: {
                        en: {
                            ...
                            noEventForToday: "No Booking for today.. so take a rest! :)",
                            noEventForThisDay: "No Booking for this day.. so take a rest! :)"
                        },
                        es: {
            ...
            i.startingDay = null, i.monthLength = null, i.$current = {
                ...
                tablet: 768,
                mobile: 425
            }, i.formatDate = e.proxy(i.formatDate, i), i.selectDate = e.proxy(i.selectDate, i), i.selectMonth = e.proxy(i.selectMonth, i), i.selectYear = e.proxy(i.selectYear, i), i.selectEvent = e.proxy(i.selectEvent, i), i.toggleSidebar = e.proxy(i.toggleSidebar, i), i.toggleEventList = e.proxy(i.toggleEventList, i), i.instanceUid = t++, i.init(!0)
        }
        ...
        for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++)
            if (a.options.calendarEvents[i].date instanceof Array)
                for (var o = a.getBetweenDates(a.options.calendarEvents[i].date), l = 0; l < o.length; l++) e === o[l] && t === a.options.calendarEvents[i].type && n++;
        ...
        if (i.children().length > 0 && i.empty(), t.options.calendarEvents)
            ...
            new Date(t.$active.date).getMonth() + 1 + " " + new Date(t.$active.date).getDate() == new Date(t.options.calendarEvents[o].date).getMonth() + 1 + " " + new Date(t.options.calendarEvents[o].date).getDate() && l(t.options.calendarEvents[o])
        }
        function l(e) {
        ...
        var t, a = this,
            n = a.$elements.eventEl.find(".event-list");
        0 !== n.find('[data-event-index="' + e + '"]').length && (n.find('[data-event-index="' + e + '"]').remove(), 0 === n.find("[data-event-index]").length && (n.empty(), t = a.$active.date === a.$current.date ? `<p>${a.initials.dates[a.options.language].noEventForToday}</p>` : `<p>${a.initials.dates[a.options.language].noEventForThisDay}</p>`, n.append(t)))
        ...
        for (var n = 1, i = 0; i < 9; i++) {
            for (var o = 0; o < a.$label.days.length; o++) {
                if (n <= a.monthLength && (i > 0 || o >= a.startingDay)) {
                    var l = "calendar-day";
                    a.$label.days[o] !== a.initials.weekends.sat && a.$label.days[o] !== a.initials.weekends.sun || (l += " --weekend"), e += '<td class="' + l + '">', e += '<div class="day" role="button" data-date-val="' + a.formatDate(a.$label.months[a.$active.month] + " " + n + " " + a.$active.year, a.options.format) + '">' + n + "</div>", n++
                } else e += "<td>";
                e += "</td>"
            }
        ...
        if (i instanceof Array) {
            if (e.everyYear)
                for (var l = 0; l < i.length; l++) i[l] = n.formatDate(new Date(i[l]).setFullYear(n.$active.year), n.options.format);
        ...
        if (a instanceof Array)
            for (var i = t.getBetweenDates(a), o = 0; o < i.length; o++) l(i[o]);
        else l(a);
        function l(e) {
        ...
        "string" == typeof t || "number" == typeof t ? 4 === parseInt(t).toString().length && (n = parseInt(t)) : (a = e(t.target).closest("[data-year-val]"), n = e(a).data("yearVal")), "prev" == n ? --i.$active.year : "next" == n ? ++i.$active.year : "number" == typeof n && (i.$active.year = n), o <= i.$breakpoints.mobile && l && i.toggleSidebar(!1), i.buildSidebarYear(), i.buildCalendar()
        ...
        var a, n, i, o, l, s = this,
            r = s.$active.date;
        "string" == typeof t || "number" == typeof t || t instanceof Date ? (a = s.formatDate(new Date(t), s.options.format), n = new Date(a).getFullYear(), i = new Date(a).getMonth(), s.$active.year !== n && s.selectYear(n), s.$active.month !== i && s.selectMonth(i), o = s.$elements.innerEl.find("[data-date-val='" + a + "']")) : a = (o = e(t.currentTarget)).data("dateVal"), l = s.$active.date === a, s.$active.date = a, s.$active.event_date = a, s.$elements.innerEl.find("[data-date-val]").removeClass("calendar-active"), o.addClass("calendar-active"), l || s.buildEventList(), e(s.$elements.calendarEl).trigger("selectDate", [s.$active.date, r])
