                ...
                <div class="col-md-12">
                    <div class="card-box shadow">
                        ...
                        <div class="text-right">
                            <button @click="update" class="btn btn-primary"> <i class="fas fa-save"></i>
                                Update</button>
    ...
    export default {
        ...
        methods: {
            ...
            update() {
                ...
                axios.put(`/admin/make/${this.data.id}`, this.data)
                    .then(() => {
                        this.$alertify.success('Make updated successfully');
                        this.$nextTick(() => {
