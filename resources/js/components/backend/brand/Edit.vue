                ...
                <div class="col-md-12">
                    <div class="card-box shadow">
                        ...
                        <div class="text-right">
                            ...
                            <a href="/admin/brand" class="btn btn-danger"><i class="fas fa-times"></i>
                                Cancel
                            </a>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            submit: function () {
                ...
                axios.put(`/admin/brand/${this.item.id}`, this.data)
                    .then(() => {
                        this.$alertify.success("Brand Updated Successfully!");
                        this.$nextTick(() => {
